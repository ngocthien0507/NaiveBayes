...
export function fromJson(jsonStr) {
    ...
    STATE_KEYS.forEach(function (k) {
        if (typeof parsed[k] === 'undefined' || parsed[k] === null) {
            throw new Error(
                'Naivebayes.fromJson: JSON string is missing an expected property: `' +
                k +
                '`.',
            );
        }
    ...
    async categorize(text) {
        ...
        Object.keys(self.categories).forEach(function (category) {
            ...
            Object.keys(frequencyTable).forEach(function (token) {
                ...
                console.log(token, frequencyInText, tokenProbability, Math.log(tokenProbability))
                logProbability += frequencyInText * Math.log(tokenProbability);
                console.log({ logProbability })
            });
